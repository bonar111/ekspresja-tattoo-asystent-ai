...
const Hero = () => {
  ...
  const handleScrollToWorks = (e: React.MouseEvent<HTMLAnchorElement>) => {
    ...
    // wysokość sticky headera z CSS var ustawianą w Navbarze
    const varVal =
    ...
    >
      <div className="container relative z-10 px-4 text-center">
        ...
        >
          <h1
            id="hero-heading"
            className="mb-3 text-[28px] leading-tight font-extrabold sm:text-5xl"
          >
          ...
          <p className="mb-5 text-base sm:text-xl">
            ...
            <strong>
              Napisz — wyślemy 2 propozycje i najbliższe terminy.
            </strong>
          </p>
          ...
          <p className="mt-3 text-xs opacity-90">
            <strong>5.0★</strong> • Kraków • Bez opłaty • Odpowiadamy w kilka
            minut
          </p>
        </motion.div>
      </div>
